...
We compare fourteen criteria. Four are standard internal indices evaluated
...
independent sample. The thirteenth, \emph{SGS-Dip}, replaces the per-node
...
per node); the fourteenth adds a Bonferroni multiple-testing correction to it.
...
scenes ESS-Dip is the \emph{best of all fourteen methods} ($0.50$ versus
