...
\begin{itemize}
  ...
  \item We evaluate fourteen criteria on a factorial simulation with known $K$,
    including the calibrated-validity-index method of \citet{HennigLin2015} that
    ESS-Dip generalises;
    ESS-Dip attains the best balanced score, with the highest exact-$K$ recovery
    among the methods that reach unit specificity, and an ablation attributes the
